...
export default {
    ...
    methods: {
        initMap() {
            ...
            searchPlaces(keyword, markerList);
            this.markerList = markerList;
            console.log(this.markerList);

            // 키워드 검색을 요청하는 함수
            function searchPlaces(keyword, markerList) {
            ...
            function displayPlaces(places, markerList) {
            ...
            function saveMarker(place, markerList){
                let check = true;
                var len = markerList.length;
                for (let index = 0; index < len; index++) {
                    if(markerList[index][0] === place.y){
                        if(markerList[index][1] === place.x){
                            check = false;
                        }
                    }
                }
